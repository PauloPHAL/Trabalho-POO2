...
public class PesquisarFabricante extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBoxTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ALL", "Nome", "Pais" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.gerTarefas.carregarTabela(jTable1, this, Fabricante.class, this.txtPesq.getText(), this.jComboBoxTipo.getSelectedIndex());
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int linha = this.jTable1.getSelectedRow();
        if ( linha >= 0 ) {
            this.gerTarefas.getGerEdicao().setFabricanteSelecionado((Fabricante)this.jTable1.getValueAt(linha, 0));
